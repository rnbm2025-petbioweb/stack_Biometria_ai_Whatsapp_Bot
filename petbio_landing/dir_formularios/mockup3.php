...
<script>
  ...
  <div class="bg-white rounded-xl shadow-lg p-6 max-w-2xl w-full space-y-6">
    ...
    <form method="POST" enctype="multipart/form-data" class="space-y-4">
      <div class="text-center">
        <input type="file" name="img_hf15" accept="image/*" required
    ...
    <?php if ($preview_hf15): ?>
      <div class="text-center pt-6">
        <button onclick="window.location.href='mockup4.php'"
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      localStorage.setItem('paso_petbio', 'mockup3');
      <?php if ($preview_hf15): ?>
        localStorage.setItem('foto15', '<?= $preview_hf15 ?>');
      <?php endif; ?>
    });
  </script>
